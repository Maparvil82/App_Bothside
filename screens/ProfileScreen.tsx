...
const styles = StyleSheet.create({
  ...
  avatar: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#000', justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: '#e0e0e0' },
  avatarText: { color: 'white', fontSize: 36, fontWeight: '600' },
  changeAvatarText: { fontSize: 14, color: '#000', marginBottom: 15 },
